    ...
    if (show_help):
        ...
        try:
            if (None != input_file_name):
                ...
                in_buffering_mode = 1  # line-buffered 
                in_file = io.open(input_file_name, mode=read_text_io_mode, encoding=input_charset_name, newline=in_newline_mode, buffering=in_buffering_mode)
                in_io = in_file
            ...
            execute(in_csv, out_csv, input_delimiter, output_delimiter, input_row_start, input_row_count_max)
